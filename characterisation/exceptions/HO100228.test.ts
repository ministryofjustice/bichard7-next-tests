...
describe.ifPhase1("HO100228", () => {
  afterAll(async () => {
    await new World({}).db.closeConnection()
  })

  it.skip("Two pairs of HO100228 exceptions, in two PNC court cases", async () => {
  ...
  it.skip("Two pairs of HO100228 exceptions, in one PNC court case", async () => {
    const inputMessage = generateSpiMessage({
      offences: [
        { offenceSequenceNumber: 1, code: "CJ88144", results: [{ code: 1015 }, { code: 1115 }] },
        { offenceSequenceNumber: 1, code: "CJ88144", results: [{ code: 1015 }] }
  ...
  it.skip("3 similar court offences, 2 pnc offences - one added in court", async () => {
    const inputMessage = generateSpiMessage({
      offences: [
        { offenceSequenceNumber: 1, code: "CJ88144", results: [{ code: 1015 }] },
