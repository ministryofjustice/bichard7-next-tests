Feature: {222} BR7-R5.5-RCD576-PNC_No_Adj-Existing_Offences_Adj_With_Judg-Offence_Added_Adj_Pre_Judg

			"""
			{222} BR7-R5.5-RCD576-PNC_No_Adj-Existing_Offences_Adj_With_Judg-Offence_Added_Adj_Pre_Judg
			===============
	...
	Scenario: <add human readable test description>
		...
		And there is a valid record for "q-solution test 222" in the PNC
		When message id "q-solution/222" is received
