Feature: {310} BR7-R5.10-RCD655-Case Re-Opened-Stat Dec-Business Scenario 6

			"""
			{310} BR7-R5.10-RCD655-Case Re-Opened-Stat Dec-Business Scenario 6
			===============
			...
			Court Hearing results are sent through the CJSE and onto Bichard7 detailing the Appearance to make a Statutory Declaration - as well as another Non-Recordable Offence - using the original Case ASN and PTIURN.
	...
	Scenario: <add human readable test description>
		...
		And there is a valid record for "q-solution test 310" in the PNC
		When message id "q-solution/310" is received
