Feature: {306} BR7-R5.10-RCD655-Case Re-Opened-Stat Dec-Business Scenario 2

			"""
			{306} BR7-R5.10-RCD655-Case Re-Opened-Stat Dec-Business Scenario 2
			===============
			...
			The Application to Re-Open the Case is accepted at the Hearing.
			Court Hearing results are sent through the CJSE and onto Bichard7 detailing the Application to Re-Open the Case - as well as another Non-Recordable Offence - using the original Case ASN and PTIURN.
	...
	Scenario: <add human readable test description>
		...
		And there is a valid record for "q-solution test 306" in the PNC
		When message id "q-solution/306" is received
