Feature: R3_BR7_SI_002 (PUF = Inclusion)

			"""
			R3_BR7_SI_002 (PUF = Inclusion)
			===============
			...
			This Test verifies behaviour of this Filter where the Portal Update Filter is set to "Inclusion".
	...
	Scenario: <add human readable test description>
		...
		And there is a valid record for "q-solution test R3_BR7_SI_002" in the PNC
		When message id "q-solution/R3_BR7_SI_002" is received
