Feature: {243} BR7 R5.6-RCD592-Parent Warrant-4585

			"""
			{243} BR7 R5.6-RCD592-Parent Warrant-4585
			===============
			Q-Solution Definition:
			A Bichard7 Regression Test verifying Parent Warrant handling.
	...
	Scenario: <add human readable test description>
		...
		And there is a valid record for "q-solution test 243" in the PNC
		When message id "q-solution/243" is received
