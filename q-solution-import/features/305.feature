Feature: {305} BR7-R5.10-RCD655-Case Re-Opened-Stat Dec-Business Scenario 1

			"""
			{305} BR7-R5.10-RCD655-Case Re-Opened-Stat Dec-Business Scenario 1
			===============
	...
	Scenario: <add human readable test description>
		...
		And there is a valid record for "q-solution test 305" in the PNC
		When message id "q-solution/305" is received
