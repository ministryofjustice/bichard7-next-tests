Feature: {206} 3.2 UAT_TRPR0007

			"""
			{206} 3.2 UAT_TRPR0007
			===============
	...
	Scenario: <add human readable test description>
		...
		And there is a valid record for "q-solution test 206" in the PNC
		When message id "q-solution/206" is received
